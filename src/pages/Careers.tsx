      ...
      <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 relative z-10">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <motion.div
            ...
            className="w-20 h-20 rounded-full bg-vant-t/20 flex items-center justify-center mx-auto mb-8"
          >
            <Clock className="w-10 h-10 text-vant-t" />
          </motion.div>
          ...
          >
            We're building an amazing team. Stay tuned for exciting career opportunities. 
          ...
          >
            <Link to="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-xl bg-vant-t text-foreground font-logo font-bold hover:bg-vant-t/90 transition-colors"
              >
                Get in Touch
              </motion.button>
            </Link>
