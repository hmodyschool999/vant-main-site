      ...
      <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 relative z-10">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <motion.div
            ...
            className="w-20 h-20 rounded-full bg-vant-n/20 flex items-center justify-center mx-auto mb-8"
          >
            <Clock className="w-10 h-10 text-vant-n" />
          </motion.div>
          ...
          >
            We're building a comprehensive status page to keep you informed about our services. 
          ...
          >
            <Link to="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-xl bg-vant-n text-foreground font-logo font-bold hover:bg-vant-n/90 transition-colors"
              >
                Get Notified
              </motion.button>
            </Link>
